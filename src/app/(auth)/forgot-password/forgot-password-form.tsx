  ...
  function handleSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    startTransition(async () => {
      try {
        ...
        // Provider or database failures are not presented as a successful
        // request, and the generic copy does not expose internal details.
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-5" noValidate>
      ...
      <MorphingButton
        ...
        state={isPending ? "pending" : error ? "error" : success ? "success" : "idle"}
        labels={{
